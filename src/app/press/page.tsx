    ...
    <>
      <section className="page-hero">
        ...
        <p className="page-hero__text">
          Rare Passages is a specialist travel group. It builds and operates consumer brands — Safari Awaits is the first — that match travelers to the right trip with published methods, full cost transparency and the willingness to say no. It owns no lodges, ships or rolling stock; it examines and represents the people who do.
        </p>
      </section>
      ...
      <section className="section">
        ...
        <ul className="plain-list">
          <li><Link href="/brand">Rare Passages brand guidelines and kit</Link> — mark, lockups, color, type, usage.</li>
